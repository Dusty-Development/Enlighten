...
import net.dustley.enlighten.particle.wispflare.WispParticle
...
object ModParticles {
    ...
    val WISP_PARTICLE: SimpleParticleType = FabricParticleTypes.simple()
    ...
    fun registerParticles() {
        ...
        Registry.register(Registries.PARTICLE_TYPE, Enlighten.identifier("wisp_particle"), WISP_PARTICLE)
    }
    ...
    fun registerClientParticles() {
        ...
        ParticleFactoryRegistry.getInstance().register(WISP_PARTICLE) { sprites -> WispParticle.Companion.Factory(sprites) }
    }
}